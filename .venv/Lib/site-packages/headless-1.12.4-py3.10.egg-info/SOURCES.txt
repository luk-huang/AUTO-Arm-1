...
setup.py
docs/source/conf.py
examples/oauth2-callback.py
examples/picqer-list-products.py
examples/picqer-list-webhooks.py
examples/picqer-ratelimit.py
examples/picqer-traverse-api.py
examples/piqcer-list-picklist-products.py
examples/shopify-get-orders.py
examples/shopify-inspect-catalog.py
examples/shopify-ratelimit.py
examples/shopify-set-inventory.py
...
headless/ext/oauth2/models/authorizationrequest.py
...
tests/ext/oauth2/test_system_discover_teamleader.py